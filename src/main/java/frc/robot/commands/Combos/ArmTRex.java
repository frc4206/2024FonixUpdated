...
public class ArmTRex extends SequentialCommandGroup {
  public ArmTRex(ElevatorSubsystem elevator, ShoulderSubsystem shoulder, WristSubsystem wrist) {
    ...
    GlobalVariables.wristdesiredpos = 23;
    addCommands(
      new ParallelCommandGroup(
        ...
        new GoToPositionWrist(wrist, 23) //0.579
      ).withTimeout(4)
    );
  }
}
