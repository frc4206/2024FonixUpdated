...
public class MiddleandExit extends SequentialCommandGroup {
  int id = (int)SmartDashboard.getNumber("Location", 7);
  ...
  public MiddleandExit(SwerveSubsystem swerve, ElevatorSubsystem elevator, ShoulderSubsystem shoulder, WristSubsystem wrist, ClawSubsystem claw) {
    addCommands(
      ...
      new ArmMiddle(elevator, shoulder, wrist).withTimeout(0.675),
      new PID_DistanceOdometry(swerve, true, true, pose4[0]-0.5, pose4[1], pose4[2], 1.25, true, false, false, false)
